...
namespace VatTuYTe.Controllers
{
    public class VaiTroController : Controller
    {
        ...
        public IActionResult loadTableCN(int idvt)
        {
            ...
            List<ChucNang> listcn = context.ChucNang.Where(x => x.Idvt == idvt).ToList();
        ...
        public JsonResult updateRoles([FromBody] IEnumerable<FunctionModel> list)
        {
            ...
            foreach (var item in list)
            {
                ...
                if (cn == null)
                {
                    ...
                    if (item.Nhap == false && item.Sua == false && item.Xoa == false && item.Xuat == false && item.In == false && item.CaNhan == false)
                    {
                        cnn.Active = false;
                    }
                    else
                ...
                else
                {
                    ...
                    if (item.Nhap == true || item.Sua == true || item.Xoa == true || item.Xuat == true || item.In == true || item.CaNhan == true)
                    {
                        cn.Active = true;
                    }
                    else
